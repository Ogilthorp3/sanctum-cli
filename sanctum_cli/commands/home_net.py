...
def _fw_host() -> str:
    # ip-allow: shipped LAN default for Firewalla; overridden via devices.firewalla.host
...
def probe_hub() -> HubReach:
    # ip-allow: Bell GigaHub default mgmt; overridden via devices.hub.host when dual-homed
